...
export type MarkdownEditorToolbar = boolean | MarkdownEditorToolBarConfig;

export type MarkdownEditorToolBarConfig = (
  | MarkdownEditorToolBarName
  | '|'
...
export type MarkdownEditorToolbarFuncName =
  | 'toggleBold'
  | 'toggleItalic'
  | 'toggleStrikethrough'
  | 'toggleBlockquote'
...
export type ToolBarFuncs = {
  [key in MarkdownEditorToolbarFuncName]: (
    editor: SimpleMarkdownEditor
  ) => void;
};
...
export type MarkdownEditorShortcuts = {
...
export type MarkdownEditorShortcutsKey =
  | 'toggleBlockquote'
  | 'toggleBold'
  | 'cleanBlock'
  | 'toggleHeadingSmaller'
